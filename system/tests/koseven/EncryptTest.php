 ...
 */
class Koseven_EncryptTest extends Unittest_TestCase
{
	/**
	...
	{
		// initialize
		$e = new Koseven_EncryptTest_IvStubbed($key, $iv, $mode, $cipher);
	...
	{
		// load config
		$config = Koseven::$config->load('encrypt');
...
/**
 * Class Koseven_EncryptTest_IvStubbed wraps the Encrypt class to mock out
 * the actual mcrypt_create_iv calls for unit testing.
 */
class Koseven_EncryptTest_IvStubbed extends Encrypt
{
...
/**
 * Class Koseven_EncryptTest_KeyNormalized wraps the Encrypt class to mock out
 * the actual mcrypt_create_iv calls for unit testing, as well as to always
 * normalize keys
 */
class Koseven_EncryptTest_KeyNormalized extends Koseven_EncryptTest_IvStubbed
{
