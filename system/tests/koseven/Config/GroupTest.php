 ...
 */
class Koseven_Config_GroupTest extends TestCase
{
	/**
	 * Create a mock Koseven_Config instance
	 *
	 * @return Koseven_Config
	 */
	public function get_mock_config()
	{
		return new Koseven_Config;
	}

	/**
	 * Gets a fresh instance of Koseven_Config_Group
	 *
	 * @param string        $group    Config Group name
	 * @param array         $config   Configuration
	 * @param Koseven_Config $instance Instance of Koseven_Config
	 * @return Koseven_Config_Group
	 */
	public function get_mock_group($group, $config = [], $instance = NULL)
	{
		...
		return new Koseven_Config_Group($instance, $group, $config);
	}
	...
	public function test_loads_group_name_and_values_in_constructor()
	{
		...
		// by casting the object in question into an array.  This usually works fine, but as Koseven_Config_Group
	 ...
	 *
	 * @test
	 * @covers Koseven_Config_Group::get
	 */
	public function test_get_fetches_config_value()
	{
		$group = $this->get_mock_group('Koseven', ['status' => 'awesome']);
	...
	{
		$group = $this->get_mock_group('Koseven');
	 ...
	 *
	 * @test
	 * @covers Koseven_Config_Group::set
	 */
	public function test_set_modifies_existing_config()
	{
		$group = $this->get_mock_group('Koseven', ['status' => 'pre-awesome']);
	 ...
	 *
	 * @test
	 * @covers Koseven_Config_Group::offsetSet
	 */
	public function test_writes_changes_to_config()
	{
		$mock  = $this->createMock('Koseven_Config', ['_write_config']);

		$mock
			->expects($this->exactly(3))
			->method('_write_config')
			->with('Koseven', 'status', $this->LogicalOr('totally', 'maybe', 'not'));

		$group = $this->get_mock_group('Koseven', ['status' => 'kool'], $mock);
	 ...
	 *
	 * @test
	 * @covers Koseven_Config_Group::as_array
	 */
	 ...
	 *
	 * @test
	 * @covers Koseven_Config_Group::__toString
	 */
	public function test_to_string_serializes_array_output()
	{
		$vars   = ['Koseven' => 'cool', 'unit_tests' => 'boring'];
