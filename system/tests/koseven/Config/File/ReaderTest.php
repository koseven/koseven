 ...
 */
class Koseven_Config_File_ReaderTest extends Koseven_Unittest_TestCase {
	 ...
	 *
	 * @test
	 * @covers Koseven_Config_File_Reader
	 */
	public function test_default_search_dir_is_config()
	{
		$reader = new Koseven_Config_File_Reader;
	...
	{
		$reader = new Koseven_Config_File_Reader('gafloog');
	 ...
	 *
	 * @test
	 * @covers Koseven_Config_File_Reader::load
	 */
	public function test_load_returns_empty_array_if_conf_dir_dnx()
	{
		$config = new Koseven_Config_File_Reader('gafloogle');
	...
	{
		$config = new Koseven_Config_File_Reader;
