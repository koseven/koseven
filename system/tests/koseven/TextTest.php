...
/**
 * Tests the koseven text class (Koseven_Text)
 *
 * @group koseven
 * @group koseven.core
 * @group koseven.core.text
 *
 * @package    Koseven
 * @category   Tests
 ...
 */
class Koseven_TextTest extends Unittest_TestCase
{
	...
	function provider_reduce_slashes()
	{
		return [
				['/', '//'],
				['/google/php/koseven/', '//google/php//koseven//'],
			];
	}
	...
	function provider_censor()
	{
		...
		return [
				...
				["Cake### isn't nearly as good as koseven###", "CakePHP isn't nearly as good as kosevenphp", ['php'], '#', TRUE],
	...
	function provider_widont()
	{
		return [
			 ...
			 * array(
			 * 		'with HTML at the end &nbsp;<strong>Koseven</strong>',
			 * 		'with HTML at the end <strong>Koseven</strong>',
			 * 	),
			 * 	// @issue 3499, with HTML with attributes at the end
			 * 	array(
			 * 		'with HTML at the end:&nbsp;<a href="#" title="Koseven">Koseven</a>',
			 * 		'with HTML at the end: <a href="#" title="Koseven">Koseven</a>',
			 * 	),
			 */
				[
	...
	public function provider_auto_link()
	{
		return [
			[
				'Hi there, my site is kosevenframework.org and you can email me at nobody@kosevenframework.org',
