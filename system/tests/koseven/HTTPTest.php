 ...
 */
class Koseven_HTTPTest extends Unittest_TestCase {
	...
	{
		parent::setUp();
		Koseven::$config->load('url')->set('trusted_hosts', ['www\.example\.com']);
	...
	public function provider_redirect()
	{
		return [
			...
			[
				...
				302,
				'HTTP_Exception_302',
				'http://www.example.com/koseven/index.php/page_one'
			],
			[
				'page_two',
				303,
				'HTTP_Exception_303',
				'http://www.example.com/koseven/index.php/page_two'
			],
		];
	}
