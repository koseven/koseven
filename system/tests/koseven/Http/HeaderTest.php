<?php
/**
 * Unit Tests for Koseven_HTTP_Header
 *
 * @group koseven
 * @group koseven.core
 * @group koseven.core.http
 * @group koseven.core.http.header
 * @group koseven.core.http.header
 *
 * @package    Koseven
 * @category   Tests
 ...
 */
class Koseven_HTTP_HeaderTest extends Unittest_TestCase {
	...
	{
		$content_type = Koseven::$content_type.'; charset='.Koseven::$charset;
