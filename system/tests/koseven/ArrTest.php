...
/**
 * Tests the Arr lib that's shipped with koseven
 *
 * @group koseven
 * @group koseven.core
 * @group koseven.core.arr
 *
 * @package    Koseven
 * @category   Tests
 ...
 */
class Koseven_ArrTest extends Unittest_TestCase
{
	/**
	...
	public function provider_callback()
	{
		return [
			...
			['koseven::appify(this)', [['Koseven', 'appify'], ['this']]],
	...
	public function provider_extract()
	{
		return [
			[
				['Koseven' => 'awesome', 'blueflame' => 'was'],
				['Koseven', 'cakephp', 'symfony'],
				NULL,
				['Koseven' => 'awesome', 'cakephp' => NULL, 'symfony' => NULL]
			],
	...
	public function provider_path()
	{
		...
		return [
			...
			[NULL, $array, 'koseven.alternatives',  NULL],
			// Try using a string as a default
			['nothing', $array, 'koseven.alternatives',  'nothing'],
	...
	public function provider_set_path()
	{
		return [
			// Tests returns normal values
			[['foo' => 'bar'], [], 'foo', 'bar'],
			[['Koseven' => ['is' => 'awesome']], [], 'koseven.is', 'awesome'],
			[['Koseven' => ['is' => 'cool', 'and' => 'slow']],
				  ['Koseven' => ['is' => 'cool']], 'koseven.and', 'slow'],
			// Custom delimiters
			[['Koseven' => ['is' => 'awesome']], [], 'koseven/is', 'awesome', '/'],
