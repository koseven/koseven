 ...
 */
class Koseven_HTMLTest extends Unittest_TestCase {
	...
	{
		parent::setUp();
		Koseven::$config->load('url')->set('trusted_hosts', ['www\.kosevenframework\.org']);
	}
	...
	protected $environmentDefault = [
		...
		'HTML::$strict' => TRUE,
		'HTTP_HOST'	=> 'www.kosevenframework.org',
	];
	// @codingStandardsIgnoreStart
	...
	public function provider_script()
	{
		return [
			...
			[
				'<script type="text/javascript" src="http://www.kosevenframework.org/koseven/index.php/my/script.js"></script>',
				'my/script.js',
				NULL,
				'http',
				TRUE
			...
			[
				'<script type="text/javascript" src="https://www.kosevenframework.org/koseven/my/script.js"></script>',
				'my/script.js',
				NULL,
				'https',
				FALSE
	...
	public function provider_style()
	{
		return [
			...
			[
				'<link type="text/css" href="/koseven/my/style.css" rel="stylesheet" />',
				'my/style.css',
				[],
				NULL,
				FALSE
			...
			[
				'<link type="text/css" href="https://www.kosevenframework.org/koseven/my/style.css" rel="stylesheet" />',
				'my/style.css',
				[],
				'https',
				FALSE
			...
			[
				'<link type="text/css" href="https://www.kosevenframework.org/koseven/index.php/my/style.css" rel="stylesheet" />',
				'my/style.css',
				[],
				'https',
				TRUE
			...
			[
				// #4283: http://dev.kosevenframework.org/issues/4283
				'<link type="text/css" href="https://www.kosevenframework.org/koseven/index.php/my/style.css" rel="stylesheet/less" />',
				'my/style.css',
				[
					'rel' => 'stylesheet/less'
				],
	...
	public function provider_anchor()
	{
		return [
			...
			[
				'<a href="#go-to-section-koseven">Koseven</a>',
				[],
				'#go-to-section-koseven',
                'Koseven',
			],
			// a query-only anchor
			[
			...
			[
				'<a href="http://kosevenframework.org">Koseven</a>',
				[],
				'http://kosevenframework.org',
                'Koseven',
			],
			[
			...
			[
				'<a href="https://www.kosevenframework.org/koseven/users/example">Koseven</a>',
				[],
				'users/example',
                'Koseven',
				NULL,
			...
			[
				'<a href="https://www.kosevenframework.org/koseven/index.php/users/example">Koseven</a>',
				[],
				'users/example',
                'Koseven',
				NULL,
	...
	public function provider_file_anchor()
	{
		return [
			[
				'<a href="/koseven/mypic.png">My picture file</a>',
				[],
				'mypic.png',
				'My picture file',
			],
			[
				'<a href="https://www.kosevenframework.org/koseven/index.php/mypic.png" attr="value">My picture file</a>',
				['attr' => 'value'],
				'mypic.png',
				'My picture file',
				'https',
			...
			[
				'<a href="ftp://www.kosevenframework.org/koseven/mypic.png">My picture file</a>',
				[],
				'mypic.png',
				'My picture file',
				'ftp',
	...
	public function provider_image()
	{
		return [
			...
			[
				'<img src="/koseven/img/image.png" />',
				'img/image.png',
			],
			[
				'<img src="https://www.kosevenframework.org/koseven/index.php/img/image.png" alt="..." />',
				'img/image.png',
				['alt' => '...',],
				'https',
				TRUE
