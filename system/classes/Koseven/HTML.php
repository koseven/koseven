...
class Koseven_HTML {
	...
	{
		return htmlspecialchars( (string) $value, ENT_QUOTES, Koseven::$charset, $double_encode);
	}
	...
	{
		return htmlentities( (string) $value, ENT_QUOTES, Koseven::$charset, $double_encode);
	}
