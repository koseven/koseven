 ...
 *
 * [!!] This file is licensed differently from the rest of Koseven. As a port of
...
class Koseven_UTF8 {
	 ...
	 * @param   string  $charset    character set, defaults to Ksoeven::$charset
	 * @return  mixed
	 * @uses    UTF8::clean
	...
	public static function transliterate_to_ascii($str, $case = 0)
	{
		...
		{
			require Koseven::find_file('utf8', __FUNCTION__);
	 ...
	 * @uses    Koseven::$charset
	 */
	public static function strlen($str)
	{
		if (UTF8::$server_utf8)
			return mb_strlen($str, Koseven::$charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strpos($str, $search, $offset, Koseven::$charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strrpos($str, $search, $offset, Koseven::$charset);
	...
	public static function substr($str, $offset, $length = NULL)
	{
		if (UTF8::$server_utf8)
			return ($length === NULL)
				? mb_substr($str, $offset, mb_strlen($str), Koseven::$charset)
				: mb_substr($str, $offset, $length, Koseven::$charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strtolower($str, Koseven::$charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strtoupper($str, Koseven::$charset);
...
if (Koseven_UTF8::$server_utf8 === NULL)
{
	// Determine if this server supports UTF-8 natively
	Koseven_UTF8::$server_utf8 = extension_loaded('mbstring');
}
