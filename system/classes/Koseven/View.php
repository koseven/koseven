...
class Koseven_View {
	 ...
	 *
	 * @param   string  $koseven_view_filename   filename
	 * @param   array   $koseven_view_data       variables
	 * @return  string
	 * @throws  Exception
	 */
	protected static function capture($koseven_view_filename, array $koseven_view_data)
	{
		// Import the view variables to local namespace
		extract($koseven_view_data, EXTR_SKIP);
	...
	public function & __get($key)
	{
		...
		{
			throw new Koseven_Exception('View variable is not set: :var',
				[':var' => $key]);
		}
	}
	...
	public function __toString()
	{
		...
		catch (Exception $e)
		{
			 ...
			 */
			$error_response = Koseven_Exception::_handler($e);
	...
	{
		if (($path = Koseven::find_file('views', $file)) === FALSE)
		{
