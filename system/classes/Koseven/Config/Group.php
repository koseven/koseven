 ...
 */
class Koseven_Config_Group extends ArrayObject {
	 ...
	 *
	 * @param Koseven_Config $instance "Owning" instance of Kohana_Config
	 * @param string         $group    The group name
	 * @param array          $config   Group's config
	 */
	public function __construct(Koseven_Config $instance, $group, array $config = [])
	{
