...
class Koseven_Fragment {
	...
	public static function load($name, $lifetime = NULL, $i18n = NULL)
	{
		...
		if ($fragment = Koseven::cache($cache_key, NULL, $lifetime))
		{
	...
	public static function save()
	{
		...
		if (isset(Fragment::$_caches[$level]))
		{
			...
			// Cache the fragment
			Koseven::cache($cache_key, $fragment);
		}
	}
	...
	{
		// Invalid the cache
		Koseven::cache(Fragment::_cache_key($name, $i18n), NULL, -3600);
	}
