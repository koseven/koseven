 ...
 * @package    Koseven
 * @category   Logging
 * @copyright  (c) 2007-2014  Kohana Team, Jeremy Bush
 * @copyright  (c) 2014-2018  Koseven Team
 * @license    https://koseven.ga/LICENSE.md
 */
class Koseven_Log_Syslog extends Log_Writer {
	 ...
	 * @return  void
	 */
	public function __construct($ident = 'KosevenPHP', $facility = LOG_USER)
	{
		$this->_ident = $ident;
