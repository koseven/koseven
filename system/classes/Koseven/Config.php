...
class Koseven_Config {
	 ...
	 *
	 * @param   Koseven_Config_Source    $source instance
	 * @param   boolean                 $first  add the reader as the first used object
	 * @return  $this
	 */
	public function attach(Koseven_Config_Source $source, $first = TRUE)
	{
		if ($first === TRUE)
		{
	 ...
	 * @return  $this
	 */
	public function detach(Koseven_Config_Source $source)
	{
	 ...
	 *
	 * See [Koseven_Config_Group] for more info
	 *
	...
	public function load($group)
	{
		...
		{
			throw new Koseven_Exception('No configuration sources attached');
		}

		if (empty($group))
		{
			throw new Koseven_Exception("Need to specify a config group");
		}

		if ( ! is_string($group))
		{
			throw new Koseven_Exception("Config group must be a string");
		}
		...
		{
			if ($source instanceof Koseven_Config_Reader)
			{
	 ...
	 * @return Koseven_Config Chainable instance
	 */
	public function _write_config($group, $key, $value)
	{
		foreach ($this->_sources as $source)
		{
			if ( ! ($source instanceof Koseven_Config_Writer))
			{
				continue;
			}
