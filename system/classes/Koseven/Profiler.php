...
class Koseven_Profiler {
	...
	public static function application()
	{
		...
		$stats = Koseven::cache('profiler_application_stats', NULL, 3600 * 24);
		...
		$time = microtime(TRUE) - KOSEVEN_START_TIME;

		// Get the total memory usage
		$memory = memory_get_usage() - KOSEVEN_START_MEMORY;
		...
		// Cache the new stats
		Koseven::cache('profiler_application_stats', $stats);
