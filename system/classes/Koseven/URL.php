...
class Koseven_URL {
	...
	public static function base($protocol = NULL, $index = FALSE, $subdomain = NULL)
	{
		...
		if ($index === TRUE AND ! empty(Koseven::$index_file))
		{
			// Add the index file to the URL
			$base_url .= Koseven::$index_file.'/';
		}
	...
	public static function is_trusted_host($host, array $trusted_hosts = NULL)
	{
		...
		{
			$trusted_hosts = (array) Koseven::$config->load('url')->get('trusted_hosts');
		}
