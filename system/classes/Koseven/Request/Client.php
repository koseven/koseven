 ...
 * @since      3.1.0
 */
abstract class Koseven_Request_Client {
	 ...
	 * By default, Koseven's client is fully compliant with the HTTP spec. Some
	 ...
	 *
	 * As with other Koseven setter/getters, usage is:
	 *
	 *     // Set full array
