...
class Koseven_Feed {
	...
	public static function parse($feed, $limit = 0)
	{
		...
		if ( ! function_exists('simplexml_load_file'))
			throw new Koseven_Exception('SimpleXML must be installed!');
	...
	{
		$info += ['title' => 'Generated Feed', 'link' => '', 'generator' => 'KosevenPHP'];
		...
		foreach ($info as $name => $value)
		{
			if ($name === 'image')
			{
				...
				{
					throw new Koseven_Exception('Feed images require a link, url, and title');
				}
