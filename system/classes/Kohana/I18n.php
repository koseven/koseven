...
class Kohana_I18n {
	 ...
	 *
	 *     $str = I18n::get('Hello friends, my name is Alex');
	 *     $str = I18n::get(['Hello friends, my name is :name', [':name' => 'Alex']]);
	 *
	 * @param   string|array  $string  text to translate or array(text, values to replace in text)
	...
	public static function get($string, $lang = NULL)
	{
		...
		if (is_array($string))
		{
			if (isset($string[1]) AND is_array($string[1]))
			{
				$values = $string[1];
			}
		...
		if ($lang !== I18n::$lang)
		{
			...
			$string = isset($table[$string]) ? $table[$string] : $string;
		}
...
if ( ! function_exists('__'))
{
	 ...
	 *
	 *    $str = __('Welcome back, :user', [':user' => $username]);
	 *
