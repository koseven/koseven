...
[!!] The code modified in this tutorial was copied from Koseven version 3.1.x. You may need to update it to work with future releases.
...
[Download and install the Koseven framework](install); from this point on, we'll be referring to the location of the Koseven libraries as the `koseven` directory.
...
Having moved most of the code from Koseven's `index.php` to `common.php` the new `koseven/index.php` contains only this:

### File: `koseven/index.php`
...
~~~
	<?php
		require_once 'koseven/include.php';
