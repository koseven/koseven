...
2. Once we are in `bootstrap.php`:
	6. The [Koseven] class is loaded.
	7. [Koseven::init] is called, which sets up error handling, caching, and logging.
	8. [Koseven_Config] readers and [Koseven_Log] writers are attached.
	9. [Koseven::modules] is called to enable additional modules.
